...
part of 'voucher_order_model.dart';
...
/// @nodoc
abstract mixin class $VoucherOrderModelCopyWith<$Res>  {
  factory $VoucherOrderModelCopyWith(VoucherOrderModel value, $Res Function(VoucherOrderModel) _then) = _$VoucherOrderModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$VoucherOrderModelCopyWithImpl<$Res>
    implements $VoucherOrderModelCopyWith<$Res> {
  _$VoucherOrderModelCopyWithImpl(this._self, this._then);

  final VoucherOrderModel _self;
  final $Res Function(VoucherOrderModel) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? full_name = freezed,Object? message = freezed,Object? voucher_amount = freezed,Object? created_at = freezed,Object? expiry_date = freezed,Object? voucher_no = freezed,Object? status = freezed,Object? cash_payment_amount = freezed,Object? card_payment_amount = freezed,Object? payment_status = freezed,Object? payment_status_name = freezed,Object? is_exist_in_order = freezed,}) {
  return _then(VoucherOrderModel(
...
/// Adds pattern-matching-related methods to [VoucherOrderModel].
extension VoucherOrderModelPatterns on VoucherOrderModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _VoucherOrderModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _VoucherOrderModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _VoucherOrderModel value)  $default,){
final _that = this;
switch (_that) {
case _VoucherOrderModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _VoucherOrderModel value)?  $default,){
final _that = this;
switch (_that) {
case _VoucherOrderModel() when $default != null:
return $default(_that);case _:
...
class _VoucherOrderModel implements VoucherOrderModel {
  const _VoucherOrderModel({this.id, this.full_name, this.message, this.voucher_amount, this.created_at, this.expiry_date, this.voucher_no, this.status, this.cash_payment_amount, this.card_payment_amount, this.payment_status, this.payment_status_name, this.is_exist_in_order});
  factory _VoucherOrderModel.fromJson(Map<String, dynamic> json) => _$VoucherOrderModelFromJson(json);
...
@override
String toString() {
    return 'VoucherOrderModel(id: $id, full_name: $full_name, message: $message, voucher_amount: $voucher_amount, created_at: $created_at, expiry_date: $expiry_date, voucher_no: $voucher_no, status: $status, cash_payment_amount: $cash_payment_amount, card_payment_amount: $card_payment_amount, payment_status: $payment_status, payment_status_name: $payment_status_name, is_exist_in_order: $is_exist_in_order)';
}
...
/// @nodoc
abstract mixin class _$VoucherOrderModelCopyWith<$Res> implements $VoucherOrderModelCopyWith<$Res> {
  factory _$VoucherOrderModelCopyWith(_VoucherOrderModel value, $Res Function(_VoucherOrderModel) _then) = __$VoucherOrderModelCopyWithImpl;
@override @useResult
$Res call({
 int? id, String? full_name, String? message, double? voucher_amount, DateTime? created_at, DateTime? expiry_date, int? voucher_no, bool? status, double? cash_payment_amount, double? card_payment_amount, int? payment_status, String? payment_status_name, bool? is_exist_in_order
});
...
/// @nodoc
class __$VoucherOrderModelCopyWithImpl<$Res>
    implements _$VoucherOrderModelCopyWith<$Res> {
  __$VoucherOrderModelCopyWithImpl(this._self, this._then);

  final _VoucherOrderModel _self;
  final $Res Function(_VoucherOrderModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? full_name = freezed,Object? message = freezed,Object? voucher_amount = freezed,Object? created_at = freezed,Object? expiry_date = freezed,Object? voucher_no = freezed,Object? status = freezed,Object? cash_payment_amount = freezed,Object? card_payment_amount = freezed,Object? payment_status = freezed,Object? payment_status_name = freezed,Object? is_exist_in_order = freezed,}) {
  return _then(_VoucherOrderModel(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,full_name: freezed == full_name ? _self.full_name : full_name // ignore: cast_nullable_to_non_nullable
as String?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,voucher_amount: freezed == voucher_amount ? _self.voucher_amount : voucher_amount // ignore: cast_nullable_to_non_nullable
