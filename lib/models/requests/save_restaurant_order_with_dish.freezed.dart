...
class _SaveRestaurantOrderWithDishRequest implements SaveRestaurantOrderWithDishRequest {
  const _SaveRestaurantOrderWithDishRequest({this.order, this.orderDish, this.selectedChair, this.workingBill, this.orderPolicyName,  List<OrderTableModel> tables = const [],  List<FloorObjectReferenceModel> floorObjects = const [], this.splitBillByGuest, this.terminal_id, this.user_id, this.platform_id, this.quick_order_type_enabled, this.active_auto_bag_charge, this.restaurant_id, this.oneBag, this.delivery_ChargeId,  List<ChargeModel> charges = const [], this.bag_ChargeId, this.commet_call_id, this.table_time, this.confirmation_time, this.notification_time, this.max_free_dish_on_confirm}): _tables = tables,_floorObjects = floorObjects,_charges = charges;
  factory _SaveRestaurantOrderWithDishRequest.fromJson(Map<String, dynamic> json) => _$SaveRestaurantOrderWithDishRequestFromJson(json);
...
class _OneBagRequestModel implements OneBagRequestModel {
  ...
  factory _OneBagRequestModel.fromJson(Map<String, dynamic> json) => _$OneBagRequestModelFromJson(json);
